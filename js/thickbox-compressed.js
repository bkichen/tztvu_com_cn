    ...
    try {
        ...
        if (j == '.jpg' || j == '.jpeg' || j == '.png' || j == '.gif' || j == '.bmp') {
            ...
            if (f.indexOf('TB_iframe') != -1) {
                ...
                if (m['modal'] != "true") {
                    $("#TB_window").append("<div id='TB_title'><div id='TB_ajaxWindowTitle'>" + d + "</div><div id='TB_closeAjaxWindow'><a href='#' style='text-decoration:none;' id='TB_closeWindowButton' title='点击关闭窗口'>点击关闭窗口</a></div></div><iframe frameborder='0' hspace='0' src='" + urlNoQuery[0] + "' id='TB_iframeContent' name='TB_iframeContent" + Math.round(Math.random() * 1000) + "' onload='tb_showIframe()' style='width:" + (ajaxContentW + 29) + "px;height:" + (ajaxContentH + 17) + "px;' > </iframe>")
                } else {
                    $("#TB_overlay").unbind();
