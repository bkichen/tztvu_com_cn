...
function ShowLogin(){ 
 $.dialog.open(installdir+"user/userlogin.asp?Action=Poplogin",{fixed:true,lock:true,title:"用户登录",width:340,height:400,max:false,min:false});
}
